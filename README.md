...
- 🎨 **ANSI Terminal Plugin**: [dotdok132/lvlang-ansi](https://github.com/dotdok132/lvlang-ansi) (`LibID 0x0A` — Colors, Cursor, RGB, TUI)
- 🧠 **Dynamic Heap Memory Plugin**: [dotdok132/lvlang-heap](https://github.com/dotdok132/lvlang-heap) (`LibID 0x09` — MALLOC/FREE Allocation)
- 🌐 **TCP & HTTP Network Plugin**: [dotdok132/lvlang-net](https://github.com/dotdok132/lvlang-net) (`LibID 0x0B` — Sockets & HTTP GET)
- 🤖 **Model Context Protocol (MCP) Server**: [dotdok132/lvlang-mcp](https://github.com/dotdok132/lvlang-mcp) (Native MCP Tool Server for AI Agents)
